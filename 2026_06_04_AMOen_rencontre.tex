...
\begin{frame}[t]{Performance des sites en exploitation}
    \slideimage[0.72\textheight]{img/02_performance_sites_general_01_exploitation}%
	\vfill
...
\begin{frame}[t]{Performance des sites terminés}
    \slideimage[0.82\textheight]{img/02_performance_sites_general_03_termines}
    \vfill
...
\begin{frame}[t]{Performance vs IDC 1/2}
    \slideimage[0.925\textheight]{img/02_performance_sites_general_04_termines_idc}
\end{frame}

\begin{frame}[t]{Performance vs IDC 2/2}
    \slideimage[0.96\textheight]{img/02_performance_sites_general_05_termines_idc}
\end{frame}
